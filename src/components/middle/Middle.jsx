...
import Styles from "../../styles/middle/middle.module.scss";
  ...
  return (
    <section className={Styles.middle}>
        <div className={Styles.content}>
            ...
            <h1 >
                {animationData.currentImgData.title}
            </h1>
            </div>
        ...
        {
            data.map((ele,ind)=>{
                return <div key={ind} className={`${Styles.img} ${animationData.currentImgData.id===ind?Styles.show:""}`}>
                <img src={ele.img} alt="" />
            </div>
            })
        }
